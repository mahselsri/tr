...
def fetch_nifty_50_stocks():
    return [
        ...
        "JSWSTEEL", "HCLTECH", "GRASIM", "BAJAJFINSV", "INDUSINDBK",
        "TECHM", "ADANIPORTS", "BPCL", "HEROMOTOCO", "SHREECEM",
        "DRREDDY", "ULTRACEMCO", "TITAN", "NTPC", "BHARTIARTL",
        "DIVISLAB", "CIPLA", "APOLLOHOSP", "BRITANNIA", "BAJAJ-AUTO",
